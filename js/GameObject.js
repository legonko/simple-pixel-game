...
const gameObjects = {
  ...
  rock:                      {spriteWidth: 2, spriteHeight: 2, spriteOffset: 0.5, spritePosX: 0, spritePosY: 2, zIndex: 1, isObstacle: true},
  smallLeave:                {spriteWidth: 1, spriteHeight: 1, spriteOffset: 0.0, spritePosX: 3, spritePosY: 2, zIndex: 0, isObstacle: false},
  smallFlowerRed:            {spriteWidth: 1, spriteHeight: 1, spriteOffset: 0.0, spritePosX: 2, spritePosY: 3, zIndex: 1, isObstacle: false},
  smallFlowerYellow:         {spriteWidth: 1, spriteHeight: 1, spriteOffset: 0.0, spritePosX: 3, spritePosY: 3, zIndex: 1, isObstacle: false},
  smallStone:                {spriteWidth: 1, spriteHeight: 1, spriteOffset: 0.0, spritePosX: 2, spritePosY: 2, zIndex: 0, isObstacle: false},
  stump:                     {spriteWidth: 1, spriteHeight: 1, spriteOffset: 0.0, spritePosX: 3, spritePosY: 4, zIndex: 1, isObstacle: true},
  smallGrass:                {spriteWidth: 1, spriteHeight: 1, spriteOffset: 0.0, spritePosX: 2, spritePosY: 4, zIndex: 1, isObstacle: false},
};

export class GameObject {
  constructor(x, y, objName) {
    this.x = x;
    this.y = y;
